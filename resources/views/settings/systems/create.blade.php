...
<div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModalLabel" aria-hidden="true" data-backdrop="static">
  <div class="modal-dialog modal-md">
    <form id="form_create" class="modal-content" method="post" onsubmit='frm_submit(event, "{{route("setting.system.save")}}")'>
      ...
      <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 mb-3">
                <label for="short_name">ឈ្មោះកាត់ <span class="text-danger">*</span></label>
